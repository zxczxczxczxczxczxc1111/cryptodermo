 ...
 *
 * ЭТО ЕДИНСТВЕННОЕ МЕСТО ВО ВСЁМ ПРИЛОЖЕНИИ, КОТОРОЕ ХОДИТ В СЕТЬ. Всё
 * остальное - крипта, файлы, буфер обмена - работает офлайн и в сеть не
 * обращается. Поэтому здесь особые правила:
 *
